  ...
  return (
    ...
    <PageHeader />
      <div ref={container} className="w-full overflow-hidden bg-black">
        ...
        {/* First container */}
        <div className=" pointer-events-none z-50 container mx-auto flex flex-col items-center gap-y-8 p-8 md:gap-y-0 lg:gap-y-16 lg:px-10 lg:py-26 lg:pb-12 xl:gap-y-28 xl:pb-32 2xl:gap-y-32">
          <PageBreadcrumbs/>
